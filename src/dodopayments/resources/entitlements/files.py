...
from ...types.entitlements.file_upload_response import FileUploadResponse
...
class FilesResource(SyncAPIResource):
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            path_template("/entitlements/{id}/files/{file_id}", id=id, file_id=file_id),
    ...
    def upload(
        ...
        *,
        ...
        if not id:
            raise ValueError(f"Expected a non-empty value for `id` but received {id!r}")
        return self._post(
            path_template("/entitlements/{id}/files", id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
