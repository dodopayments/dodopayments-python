...
from ...types.attach_product_entitlement_param import AttachProductEntitlementParam
...
class ProductsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        entitlements: Optional[Iterable[AttachProductEntitlementParam]] | Omit = omit,
    ...
    def unarchive(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            path_template("/products/{id}/unarchive", id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    def update_files(
        ...
        *,
        ...
        if not id:
            raise ValueError(f"Expected a non-empty value for `id` but received {id!r}")
        return self._put(
            path_template("/products/{id}/files", id=id),
