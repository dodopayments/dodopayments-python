...
__all__ = ["EntitlementGrantCreatedWebhookEvent", "Data", "DataLicenseKey"]
...
class EntitlementGrantCreatedWebhookEvent(BaseModel):
    business_id: str
    ...
    type: Literal["entitlement_grant.created"]
    """The event type"""
