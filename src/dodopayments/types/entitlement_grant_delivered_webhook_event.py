...
__all__ = ["EntitlementGrantDeliveredWebhookEvent", "Data", "DataLicenseKey"]
...
class EntitlementGrantDeliveredWebhookEvent(BaseModel):
    business_id: str
    ...
    type: Literal["entitlement_grant.delivered"]
    """The event type"""
