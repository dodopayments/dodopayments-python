...
from .refund_list_item_param import RefundListItemParam
...
class PaymentParam(TypedDict, total=False):
    ...
    refunds: Required[Iterable[RefundListItemParam]]
    ...
    product_cart: Optional[Iterable[OneTimeProductCartItemParam]]
    """List of products purchased in a one-time payment"""

    refund_status: Optional[PaymentRefundStatus]
