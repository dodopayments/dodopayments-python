...
__all__ = ["SubscriptionUpdatePaymentMethodWebhookEvent", "Data"]
...
class SubscriptionUpdatePaymentMethodWebhookEvent(BaseModel):
    business_id: str
    ...
    type: Literal["subscription.update_payment_method"]
    """The event type"""
